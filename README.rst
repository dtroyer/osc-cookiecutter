...
Cookiecutter template for an OpenStackClient plugin. See https://github.com/audreyr/cookiecutter.
...
Generate a Python package project::
    ...
    cookiecutter https://git.openstack.org/openstack/osc-cookiecutter
